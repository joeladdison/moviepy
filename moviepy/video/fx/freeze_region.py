...
def freeze_region(clip, t=0, region=None, outside_region=None, mask=None):
    ...
    mask
      If not None, will overlay a freezed version of the clip on the current
      clip, with the provided mask. In other words, the "visible" pixels in
      the mask indicate the freezed region in the final picture.
